...
class ValidationMetadataTest(unittest.TestCase):
    ...
    def test_valid_metadata_content(self):
        is_invalid, errors = check_metadata_file("tests/testfiles/data-processed/teamA-modelA/metadata-teamA-modelA.txt")
    ...
    def test_invalid_metadata_folder(self):
        is_invalid, errors = check_metadata_file("tests/testfiles/data-processed/teamD-modelD/metadata-teamD-modelA.txt")
        #print(is_invalid, errors)
    ...
    def test_invalid_metadata_yaml_file(self):
        is_invalid, errors = check_metadata_file("tests/testfiles/data-processed/teamA-modelA/metadata-teamA-modelC.txt")
        #print(is_invalid, errors)
        self.assertTrue(is_invalid)
    ...
    def test_invalid_metadata_file_format(self):
        is_invalid, errors = check_metadata_file("tests/testfiles/data-processed/teamA-modelA/metadata-teamA-modelB.txt")
        #print(is_invalid, errors)
        self.assertTrue(is_invalid)
        self.assertIn("METADATA ERROR: Metadata YAML Fromat Error", errors[0])
    ...
    def test_missing_model_abbr(self):
        is_invalid, errors = check_metadata_file("tests/testfiles/data-processed/teamB-modelB/metadata-teamB-modelB.txt")
        #print(is_invalid, errors)
        self.assertTrue(is_invalid)
    ...
    def test_inconsistent_model_abbr(self):
        is_invalid, errors = check_metadata_file("tests/testfiles/data-processed/teamB-modelB/metadata-teamA-modelA.txt")
        #print(is_invalid, errors)
        self.assertTrue(is_invalid)
    ...
    def test_invalid_license(self):
        is_invalid, errors = check_metadata_file("tests/testfiles/data-processed/teamC-modelC/metadata-teamC-modelC.txt")
        #print(is_invalid, errors)
        self.assertTrue(is_invalid)
