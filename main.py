...
from forecast_validation.validation_logic.github_connection import (
    ...
    establish_github_connection_local_run,
    extract_pull_request,
    extract_pull_request_local_run,
...
def setup_validation_run_for_pull_request_local() -> ValidationRun:
    
    steps = []

    # Connect to GitHub
    steps.append(ValidationStep(establish_github_connection_local_run))

    # Extract PR
    steps.append(ValidationStep(extract_pull_request_local_run))
    ...
    try:
        ...
        raise Exception("LOCAL: Stop labeling in github.")
...
def validate_from_pull_request_local() -> bool:
    validation_run: ValidationRun = setup_validation_run_for_pull_request_local()
...
if __name__ == '__main__':
    ...
    if IS_GITHUB_ACTIONS:
        ...
        success = validate_from_pull_request_local()
        if success:
            print("****************** LOCAL: success! ******************")
        else:
            sys.exit("\n LOCAL: Errors found during validation...")
        #pass